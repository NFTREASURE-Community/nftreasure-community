      ...
      this.init = function () {
          ...
          if (e.isie9mobile)
            ...
            a.onmousedown = function (b, c) {
              if (!a.rail.drag || 1 == a.rail.drag.pt) {
                ...
                a.isiframe &&
                  !e.hasmousecapture &&
                  ((a.saved.csspointerevents = a.doc.css("pointer-events")), a.css(a.doc, {"pointer-events": "none"}));
                a.hasmoving = !1;
                return a.cancelEvent(b);
              }
            };
        ...
        if ("IFRAME" == this.doc[0].nodeName) {
          var N = function () {
            ...
            if (a.iframexd) return "console" in window && console.info("NiceScroll error: policy restriced iframe"), !0;
            a.forcescreen = !0;
            a.isiframe &&
              ((a.iframe = {
                doc: f(c),
